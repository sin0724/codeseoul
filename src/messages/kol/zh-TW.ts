...
export const zhTW = {
  ...
  // Onboarding
  onboardingWelcomeTitle: '歡迎加入！🎉',
  onboardingWelcomeSubtitle: '您已成為 CODE SEOUL 認證的創作者',
  onboardingWelcomeDesc: '在開始之前，讓我們快速完成您的個人資料設置',
  onboardingFeature1: '參與品牌任務',
  onboardingFeature2: '獲得活動報酬',
  onboardingFeature3: '提升等級享更多優惠',
  onboardingStart: '開始設置',
  onboardingSkip: '先看看再說',
  onboardingStep: '第 {current} 步，共 {total} 步',
  onboardingStepBasicInfo: '基本資料',
  onboardingStepBasicInfoDesc: '這些資訊幫助品牌更了解您',
  onboardingStepContact: '聯繫方式',
  onboardingStepContactDesc: '用於緊急聯繫（可選填）',
  onboardingStepContactHint: '建議至少填寫一個聯繫方式',
  onboardingStepPayment: '付款資訊',
  onboardingStepPaymentDesc: '完成任務後用於發放報酬',
  onboardingStepPaymentSkip: '稍後再填寫',
  onboardingStepPaymentSkipHint: '您可以在完成第一個任務前隨時設定',
  onboardingCompleteTitle: '設置完成！✨',
  onboardingCompleteSubtitle: '您已準備好開始接受任務',
  onboardingCompleteCta: '查看可用任務',
  onboardingCompleteTip1: '定期查看新任務',
  onboardingCompleteTip2: '保持個人資料更新',
  onboardingCompleteTip3: '提升粉絲數可解鎖更高等級',
  onboardingNext: '下一步',
  onboardingPrev: '上一步',
  onboardingFinish: '完成設置',
  onboardingLater: '稍後完成',
  profileCompletion: '資料完成度',
  profileCompletionBannerTitle: '請完成您的個人資料！',
  profileCompletionBannerDesc: '為了申請任務，請先填寫基本資料。',
  profileCompletionBannerCta: '完成資料',
} as const;
